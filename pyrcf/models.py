"""RCF architecture from yun-liu/RCF-PyTorch; see NOTICE and LICENSE.md."""
...
class RCF(nn.Module):
    def __init__(self):
        ...
        self.register_buffer("weight_deconv2", self._make_bilinear_weights(4, 1), persistent=False)
        self.register_buffer("weight_deconv3", self._make_bilinear_weights(8, 1), persistent=False)
        self.register_buffer("weight_deconv4", self._make_bilinear_weights(16, 1), persistent=False)
        self.register_buffer("weight_deconv5", self._make_bilinear_weights(16, 1), persistent=False)
